...
public class MainActivity extends AppCompatActivity {
    ...
    private static final  String Phone_number = "099999999999";
    @Override
...
//        dialog.show();
    ...
    private final RandomRecipeListener listener = new RandomRecipeListener() {
        ...
        public void didFetch(RandomRecipeApiResponse response, String message) {
            ...
            randomAdapter = new RandomAdapter(MainActivity.this,response.recipes,recipeClick);
    ...
    private  final RecipeClick recipeClick = new RecipeClick() {
        ...
        public void onRecipeClicked(String id) {
            startActivity(new Intent(MainActivity.this,recipeDetail.class).putExtra("id",id));
        }
    };

    public void onpenContact(View view) {
        String phoneNumber = "tel: "+ Phone_number;
