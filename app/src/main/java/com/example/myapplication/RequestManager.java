...
public class RequestManager {
    ...
    public void getRandom(RandomRecipeListener listener,List<String> tags){
        CallRandomRecipes callRandomRecipes = retrofit.create(RequestManager.CallRandomRecipes.class);
        Call<RandomRecipeApiResponse> call = callRandomRecipes.callRandom(context.getString(R.string.api_key),"10",tags);
    ...
    public void getRecipeDetails(RecipeDetailsListener listener,int id){
        ...
        Call<RecipeDetail> call = callRecipeDetails.callRecipeDetail(id,context.getString(R.string.api_key));
    ...
    private interface  CallRandomRecipes{
        @GET("recipes/random")
        Call<RandomRecipeApiResponse> callRandom (
    ...
    private  interface  CallRecipeDetails{
        ...
        Call<RecipeDetail> callRecipeDetail(
                @Path("id") int id,
                @Query("apiKey")String apiKey
        );
    }
